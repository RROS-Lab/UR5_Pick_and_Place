...
class movetodesiredposition(object) :
     def __init__(self):
        ...
        grasps.grasp_posture.points = [0.032, 0.032]
     ...
     def setup_scene(self):
        ...
        for obj in self.find_result.support_surfaces:
            ...
            obj.primitive_poses[0].position.z = 0.024
        ...
        if len(self.find_result.objects) == 0:
            ...
            gripper_translation = [-0.02,0.005,0.15]   
            ...
            if box_size.dimensions[0] > box_size.dimensions[1]:
                gripper_translation = [-0.005,0.0,0.15]    
                print('vertical new')
            elif box_size.dimensions[1] > box_size.dimensions[0]:
                gripper_translation = [0.005,0.01,0.15] 
            ...
            if box_size.dimensions[0] > box_size.dimensions[1] and box_size.dimensions[0] > 0.24:
                gripper_translation = [-0.055,0.0,0.15]    
                ...
                gripper_translation = [0.005,0.05,0.15]   
            ...
            grasps.pre_grasp_approach.desired_distance = 0.117
            if box_size.dimensions[2] > 0.05:
                grasps.pre_grasp_approach.desired_distance = 0.04
                print('Higher object pick')
...
def pick():
    try:
        ...
        # plantherobot.execute_plan(open)
        # plantherobot.look_pose()
